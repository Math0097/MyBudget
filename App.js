...
// Importiamo la logica dal nostro script
import { useMoneyManager, normalizeDecimal, groupDataByColor } from './script';
import styles, { COLORS } from './style';

// Componente per il grafico a barre (rimane uguale)
...
// Componente per la lista delle transazioni (rimane uguale)
...
export default function MoneyManagerApp() {
  // Importiamo tutta la logica dal nostro custom hook
  const {
    // Navigation e view states
  ...
  // Costanti (rimangono qui perché sono solo per l'UI)
  const colors = ['#2196F3', '#4CAF50', '#FF9800', '#F44336', '#9C27B0', '#00BCD4', '#795548', '#607D8B'];

  // Funzioni di rendering (solo UI, nessuna logica)
  const renderHome = () => {
  ...
  return (
    ...
    >
      ...
      <Modal visible={showAddAccountModal} transparent={true} animationType="fade">
        <View style={{ flex: 1 }}>
          <BlurView intensity={70} tint="dark" style={{ flex: 1, position: 'absolute', width: '100%', height: '100%' }} />
          <View style={styles.modalOverlay}>
            <View style={styles.modalWrapper}>
              <View style={styles.modalContent}>
                <Text style={styles.modalTitle}>Nuova Categoria</Text>
                <View style={styles.reallocationSeparatorTitle} />
                <TextInput
                  style={styles.input}
      ...
      <Modal visible={showManageAccountsModal} transparent={true} animationType="fade">
        <View style={{ flex: 1 }}>
          <BlurView intensity={70} tint="dark" style={{ flex: 1, position: 'absolute', width: '100%', height: '100%' }} />
          <View style={styles.modalOverlay}>
            <View style={styles.modalWrapper}>
      ...
      <Modal visible={showManageSalariesModal} mtransparent={true} animationType="fade">
        <View style={{ flex: 1 }}>
          <BlurView intensity={70} tint="dark" style={{ flex: 1, position: 'absolute', width: '100%', height: '100%' }} />
          <View style={styles.modalOverlay}>
            <View style={styles.modalWrapper}>
      ...
      <Modal visible={showAddTransactionModal} transparent={true} animationType="fade">
        <View style={{ flex: 1 }}>
          <BlurView intensity={70} tint="dark" style={{ flex: 1, position: 'absolute', width: '100%', height: '100%' }} />
          <View style={styles.modalOverlay}>
            <View style={styles.modalWrapper}>
      ...
      <Modal visible={showEditAccountModal} transparent={true} animationType="fade">
        <View style={{ flex: 1 }}>
          <BlurView intensity={50} tint="light" style={{ flex: 1, position: 'absolute', width: '100%', height: '100%' }} />
      ...
      <Modal visible={showSalaryModal} transparent={true} animationType="fade">
        <View style={{ flex: 1 }}>
          <BlurView intensity={70} tint="dark" style={{ flex: 1, position: 'absolute', width: '100%', height: '100%' }} />
          <View style={styles.modalOverlay}>
            <View style={styles.modalWrapper}>
      ...
      <Modal visible={showAllocationModal} transparent={true} animationType="fade">
        <View style={{ flex: 1 }}>
          <BlurView intensity={70} tint="dark" style={{ flex: 1, position: 'absolute', width: '100%', height: '100%' }} />
          <View style={styles.modalOverlay}>
            <View style={styles.modalWrapper}>
      ...
      {/* Modal Riallocazione Soldi Rimanenti */}
      <Modal visible={showReallocationModal} transparent={true} animationType="fade">
        <View style={{ flex: 1 }}>
          <BlurView intensity={70} tint="dark" style={{ flex: 1, position: 'absolute', width: '100%', height: '100%' }} />
          <View style={styles.modalOverlay}>
            <View style={styles.modalWrapper}>
      ...
      <Modal visible={showSalaryPickerModal} transparent={true} animationType="fade">
        <View style={{ flex: 1 }}>
          <BlurView intensity={70} tint="dark" style={{ flex: 1, position: 'absolute', width: '100%', height: '100%' }} />
          <View style={styles.modalOverlay}>
            <View style={styles.modalWrapper}>
      ...
      <Modal visible={showReallocationTargetModal} transparent={true} animationType="fade">
        <View style={{ flex: 1 }}>
          <BlurView intensity={70} tint="dark" style={{ flex: 1, position: 'absolute', width: '100%', height: '100%' }} />
          <View style={styles.modalOverlay}>
            <View style={styles.modalWrapper}>
